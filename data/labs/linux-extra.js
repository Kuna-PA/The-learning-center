  ...
  4: [
    {
      ...
      tasks: [
        ...
        { t: 'ขยาย logical volume <code>lv_app</code> ให้ใช้พื้นที่ว่างทั้งหมด', hint: 'sudo lvextend -l +100%FREE /dev/vg_data/lv_app', check: s => s.lvm.lvs.lv_app.pendingResize === true },
        { t: 'ขยาย filesystem ให้เห็นพื้นที่ใหม่ (ขั้นตอนที่คนลืมบ่อยที่สุด)', hint: 'sudo resize2fs /dev/vg_data/lv_app', check: s => s.lvm.lvs.lv_app.pendingResize === false && s.filesystems.find(f => f.mp === '/mnt/app').size > 31457280 },
