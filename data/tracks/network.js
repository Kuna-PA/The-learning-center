...
<b>ติดป้ายทั้งสองปลาย</b> ทุกเส้น — ประหยัดเวลาในอนาคตมากกว่าที่คิด</div>`,
      ...
      quiz: [
        {
          type: 'mcq', img: 'assets/devices/media-converter.png',
          q: 'ต้องต่อสวิตช์ที่มีแต่พอร์ต RJ-45 เข้ากับสายไฟเบอร์ที่ลากมาจากอีกอาคาร ต้องใช้อุปกรณ์แบบในภาพเพราะอะไร',
          opts: [
            'เพื่อแปลงสัญญาณระหว่างทองแดงกับไฟเบอร์',
            'เพื่อเพิ่มจำนวนพอร์ตให้สวิตช์',
            'เพื่อกรอง traffic ก่อนเข้าอาคาร',
            'เพื่อจ่ายไฟให้อุปกรณ์ปลายทาง',
          ],
          a: 0,
          why: 'media converter แปลงสัญญาณไฟฟ้าบนทองแดง ↔ สัญญาณแสงบนไฟเบอร์ — จำเป็นเมื่ออุปกรณ์ปลายทางไม่มีช่อง SFP ให้เสียบโมดูลไฟเบอร์โดยตรง',
        },
        { type: 'mcq', q: 'ต้องการเดินสายระหว่างอาคารสองหลังห่างกัน 300 เมตร ควรใช้สายแบบใด', opts: ['ชั้น 1 Physical', 'ชั้น 2 Data Link', 'ชั้น 3 Network', 'ชั้น 4 Transport'], a: 1, why: 'สวิตช์ตัดสินใจส่งต่อโดยดู MAC address ซึ่งอยู่ในเฟรมของชั้น 2 — ส่วน router ดู IP จึงเป็นชั้น 3 และ hub เป็นชั้น 1 เพราะแค่ทวนสัญญาณต่อโดยไม่ดูอะไรเลย' },
      ...
      sections: [
        {
          ...
          h: `
<p>ก่อนไล่ตารางข้างล่าง จำหน้าตาของจริงให้ได้ก่อน — เวลาเปิดตู้แร็คหรือเดินเข้าห้องเซิร์ฟเวอร์
จะได้ชี้ถูกว่าตัวไหนคืออะไร และคุยกับช่างหน้างานรู้เรื่อง</p>
<div class="note"><b>คู่ที่คนดูผิดบ่อยที่สุด: สวิตช์ กับ ฮับ</b><br>
ทั้งคู่เป็นกล่องแบนมีพอร์ต RJ-45 เรียงกัน <b>ดูจากภายนอกแทบแยกไม่ออก</b> ต้องอ่านรุ่นที่ตัวเครื่องเอา —
ข้อต่างอยู่ที่<b>พฤติกรรม ไม่ใช่รูปร่าง</b>: ฮับทวนสัญญาณออกทุกพอร์ต (ทุกเครื่องอยู่ collision domain เดียวกัน)
ส่วนสวิตช์จำ MAC แล้วส่งเฉพาะพอร์ตปลายทาง<br>
อีกคู่ที่สับสนคือ <b>เราเตอร์</b> กับสวิตช์ — เราเตอร์ตามบ้าน/สำนักงานเล็กมักมีเสาอากาศและพอร์ตน้อยกว่า
เพราะหน้าที่หลักคือเชื่อม<b>คนละวง</b>เข้าหากัน ไม่ใช่ต่อเครื่องเยอะ ๆ</div>
<table class="tbl">
<tr><th></th><th>อุปกรณ์</th><th>ชั้น</th><th>หน้าที่</th></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/hub.png" alt="" loading="lazy"></td><td><b>Hub</b></td><td>1</td><td>ทวนสัญญาณออกทุกพอร์ต — ทุกเครื่องอยู่ collision domain เดียวกัน ปัจจุบันเลิกใช้แล้ว</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/switch.png" alt="" loading="lazy"></td><td><b>Switch</b></td><td>2</td><td>เรียนรู้ MAC แล้วส่งเฉพาะพอร์ตปลายทาง — <b>แต่ละพอร์ตเป็น collision domain ของตัวเอง</b></td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/router.png" alt="" loading="lazy"></td><td><b>Router</b></td><td>3</td><td>เชื่อมคนละวงเข้าด้วยกัน — <b>แบ่ง broadcast domain</b></td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/l3-switch.png" alt="" loading="lazy"></td><td><b>Layer 3 switch</b></td><td>2+3</td><td>สวิตช์ที่ route ระหว่าง VLAN ได้ด้วยฮาร์ดแวร์ เร็วกว่า router ทั่วไปมาก</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/firewall.png" alt="" loading="lazy"></td><td><b>Firewall</b></td><td>3–7</td><td>กรอง traffic ตามกฎ — NGFW ดูถึงระดับแอปและผู้ใช้ได้</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/access-point.png" alt="" loading="lazy"></td><td><b>Access Point</b></td><td>2</td><td>ต่อขยายวงเป็นไร้สาย</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/wlc.png" alt="" loading="lazy"></td><td><b>WLC</b></td><td>2</td><td>ตัวควบคุม AP หลายตัวจากที่เดียว — จัดการช่อง กำลังส่ง และ roaming</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/load-balancer.png" alt="" loading="lazy"></td><td><b>Load balancer</b></td><td>4 / 7</td><td>กระจายโหลดไปหลายเซิร์ฟเวอร์ พร้อม health check</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/proxy.png" alt="" loading="lazy"></td><td><b>Proxy</b></td><td>7</td><td>ตัวกลางที่ควบคุมและบันทึกการเข้าถึงเว็บ</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/ids-ips.png" alt="" loading="lazy"></td><td><b>IDS / IPS</b></td><td>3–7</td><td>ตรวจจับ / ขัดขวางการโจมตี</td></tr>
<tr><td><img class="dev-ico sm" src="assets/devices/media-converter.png" alt="" loading="lazy"></td><td><b>Media converter</b></td><td>1</td><td>แปลงทองแดง ↔ ไฟเบอร์</td></tr>
</table>
...
เห็นไฟบอก 100 Mbps ทั้งที่ควรได้ 1 Gbps แปลว่ามีคู่สายบางคู่ขาด เพราะ gigabit ต้องใช้ครบทั้ง 4 คู่</div>`,
      ...
      quiz: [
        {
          type: 'mcq', img: 'assets/devices/switch.png',
          q: 'อุปกรณ์ในภาพคืออะไร และทำงานที่ชั้นไหนของ OSI',
          opts: ['Hub — ชั้น 1', 'Switch — ชั้น 2', 'Router — ชั้น 3', 'Firewall — ชั้น 3–7'],
          a: 1,
          why: 'สังเกตพอร์ต RJ-45 จำนวนมากเรียงกันในกล่องแบน — นี่คือ switch ทำงานชั้น 2 จำ MAC ของแต่ละพอร์ตไว้ในตาราง แล้วส่งเฟรมเฉพาะพอร์ตปลายทาง',
        },
        {
          type: 'mcq', img: 'assets/devices/hub.png',
          q: 'อุปกรณ์ในภาพหน้าตาคล้ายสวิตช์มาก แต่ต่างกันตรงพฤติกรรมอย่างไร',
          opts: [
            'ทวนสัญญาณออกทุกพอร์ต ทุกเครื่องจึงอยู่ collision domain เดียวกัน',
            'route ระหว่างวงได้ด้วยฮาร์ดแวร์',
            'กรอง traffic ตามกฎความปลอดภัย',
            'จ่ายไฟให้อุปกรณ์ปลายทางผ่านสาย LAN',
          ],
          a: 0,
          why: 'ฮับเป็นอุปกรณ์ชั้น 1 — ได้อะไรมาก็ทวนออกทุกพอร์ต ทำให้ชนกันเองและแบนด์วิดท์หารกัน ปัจจุบันเลิกใช้แล้วแต่ยังเจอในระบบเก่า และแยกจากสวิตช์ด้วยตาแทบไม่ได้ ต้องดูรุ่นที่ตัวเครื่อง',
        },
        {
          type: 'mcq', img: 'assets/devices/router.png',
          q: 'ต้องการให้เครื่องในวง 192.168.1.0/24 คุยกับวง 10.0.0.0/24 ได้ ต้องใช้อุปกรณ์แบบในภาพเพราะอะไร',
          opts: [
            'เพราะมีพอร์ตให้ต่อเครื่องได้มากที่สุด',
            'เพราะทำงานชั้น 3 เชื่อมคนละวงเข้าหากันและแบ่ง broadcast domain',
            'เพราะทวนสัญญาณให้แรงขึ้น',
            'เพราะจำ MAC address ได้มากกว่าสวิตช์',
          ],
          a: 1,
          why: 'router ทำงานชั้น 3 จึงเป็นตัวเดียวที่พาข้ามวงได้และ<b>แบ่ง broadcast domain</b> ส่วนสวิตช์กับฮับส่งได้เฉพาะภายในวงเดียวกัน',
        },
        {
          type: 'mcq', img: 'assets/devices/firewall.png',
          q: 'อุปกรณ์ที่สื่อด้วยภาพนี้ควรวางไว้ตรงไหนของเครือข่าย',
          opts: [
            'กลางพื้นที่ใช้งาน เพื่อกระจายสัญญาณให้ทั่วถึง',
            'คั่นระหว่างโซนที่ไว้ใจไม่เท่ากัน เช่น ระหว่างวงภายในกับอินเทอร์เน็ต',
            'ในห้องเซิร์ฟเวอร์ ต่อกับ UPS เพื่อสำรองข้อมูล',
            'ที่ปลายสายทั้งสองฝั่ง เพื่อแปลงทองแดงเป็นไฟเบอร์',
          ],
          a: 1,
          why: 'firewall ต้องวาง<b>คั่นระหว่างโซนที่ไว้ใจไม่เท่ากัน</b> ถ้าเอาไปห้อยไว้ข้างสวิตช์ที่ทุกเครื่องต่ออยู่แล้ว traffic ภายในจะวิ่งหากันโดยไม่ผ่าน firewall เลย',
        },
        {
          type: 'mcq', img: 'assets/devices/l3-switch.png',
          q: 'อุปกรณ์ในภาพต่างจากสวิตช์ธรรมดาอย่างไร',
          opts: [
            'มีพอร์ตมากกว่า จึงต่อเครื่องได้เยอะกว่า',
            'route ระหว่าง VLAN ได้ด้วยฮาร์ดแวร์ จึงเร็วกว่าการส่งไป-กลับที่ router',
            'จ่ายไฟ PoE ให้อุปกรณ์ปลายทางได้',
            'เข้ารหัสข้อมูลระหว่างพอร์ตให้อัตโนมัติ',
          ],
          a: 1,
          why: 'Layer 3 switch ทำงานทั้งชั้น 2 และ 3 — route ข้าม VLAN ได้ในตัวด้วยชิปเฉพาะทาง ต่างจากแบบเดิมที่ต้องส่ง traffic ออกไปกลับที่ router (router-on-a-stick) ซึ่งช้ากว่ามากเมื่อ traffic ระหว่าง VLAN เยอะ',
        },
        {
          type: 'mcq', img: 'assets/devices/wlc.png',
          q: 'ออฟฟิศมี Access Point 30 ตัว อุปกรณ์ในภาพเข้ามาช่วยเรื่องอะไร',
          opts: [
            'เพิ่มความแรงสัญญาณของ AP แต่ละตัว',
            'คุม AP ทุกตัวจากที่เดียว — จัดช่องสัญญาณ กำลังส่ง และการ roaming ระหว่าง AP',
            'แปลงสัญญาณ Wi-Fi เป็นสายแลน',
            'สำรองการตั้งค่าของ AP ไว้บนคลาวด์',
          ],
          a: 1,
          why: 'WLC (Wireless LAN Controller) คุม AP หลายตัวรวมศูนย์ — ตั้งค่าทีเดียวมีผลทุกตัว เลือกช่องสัญญาณไม่ให้ทับกันเอง และทำให้เครื่องผู้ใช้เดินข้าม AP ได้โดยไม่หลุด ถ้าตั้งทีละตัว 30 ตัวจะคุมคุณภาพไม่ไหว',
        },
        {
          type: 'multi', img: 'assets/devices/server.png',
          q: 'อุปกรณ์ในภาพจัดเป็น end device — ข้อใดคือลักษณะของ end device (เลือกได้มากกว่า 1 ข้อ)',
          opts: [
            'เป็นต้นทางหรือปลายทางของข้อมูลเอง',
            'มี IP address เป็นของตัวเอง',
            'มีหน้าที่ส่งต่อเฟรมให้เครื่องอื่น',
            'ถ้าเครื่องนี้ดับ เครื่องอื่นในวงจะคุยกันไม่ได้ทั้งหมด',
          ],
          a: [0, 1],
          why: 'end device (server, PC, notebook) เป็นต้นทาง/ปลายทางของข้อมูลและมี IP ของตัวเอง ส่วนการส่งต่อเฟรมให้คนอื่นเป็นงานของสวิตช์/เราเตอร์ — เวลาไล่ปัญหาต้องแยกให้ออกก่อนว่าพังที่ปลายทางหรือที่ทางผ่าน',
        },
