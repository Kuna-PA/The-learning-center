...
หรือยกเว้นเฉพาะกลุ่มที่ต้องคุมความเร็วออกไปก่อน — นี่คือสาเหตุอันดับหนึ่งที่ "ตั้ง queue แล้วไม่ทำงาน"</div>`,
    ...
    quiz: [
      ...
      { type: 'cmd', q: 'พิมพ์คำสั่งสร้าง bridge ชื่อ <code>bridge1</code>', ans: ['/interface bridge add name=bridge1', 'interface bridge add name=bridge1'], why: 'สร้าง bridge ก่อน แล้วค่อยเอาพอร์ตมาเป็นสมาชิกด้วย /interface bridge port add — ลำดับสลับกันไม่ได้' },
