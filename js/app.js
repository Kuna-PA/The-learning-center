...
/**
 * จำนวนข้อที่ออกในหนึ่งครั้ง — ราว 70% ของคลัง แต่ไม่ต่ำกว่า 8 และไม่เกิน 15 ข้อ
 * เพดาน 15 ทำให้ยิ่งคลังใหญ่ยิ่งเดาไม่ถูก โดยข้อสอบไม่ยาวจนล้า
 * (คลัง 30 ข้อ ออก 15 ข้อ = จับคู่ได้ราว 155 ล้านชุด)
 */
const askCount = (poolSize) => (poolSize <= 8 ? poolSize : Math.min(15, Math.max(8, Math.round(poolSize * 0.7))));
