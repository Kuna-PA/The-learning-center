...
ไม่ต้องติดตั้งอะไรเลย (ไม่มี dependency, ไม่ต้อง build)
...
**ล็อกอินครั้งแรก:** ผู้ใช้ `admin` รหัสผ่าน `admin123` → เปลี่ยนรหัสผ่านทันทีที่หน้า "บัญชีของฉัน"
...
ความคืบหน้าถูกเก็บ **แยกตามบัญชี** ใน localStorage (คีย์ `sysengLC.v1:<username>`)

> ⚠️ **ข้อจำกัดที่ต้องรู้:** ระบบผู้ใช้ทำงานในเบราว์เซอร์ล้วน ไม่มีเซิร์ฟเวอร์ ไม่ได้เข้ารหัสระดับใช้งานจริง
> และไม่ sync ข้ามเครื่อง — ออกแบบมาเพื่อ **แยกความคืบหน้าของผู้เรียนหลายคนบนเครื่องเดียวกัน**
> ไม่ใช่ระบบยืนยันตัวตนจริง **อย่าใช้รหัสผ่านเดียวกับระบบงานจริง**
